...
class FtpApp():
    ...
    def __init__(self):
        ...
        self.change_to_audio_download_dir()

    def change_to_audio_download_dir(self):
        audio_download_path = '/Audio_Downloads'
        try:
            if self.ftp.pwd() != audio_download_path:
                self.chdir('Audio_Downloads')
                logging.info("Changed DIR Success... to /Audio_Downloads",)
