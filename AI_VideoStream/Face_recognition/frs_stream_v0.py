...
class FRS_Stream:
    ...
    def predict(self, img):
        ...
        try:
            ...
            if img.shape[0]==160 and img.shape[1]==160: # extracted face image with Retina-Face
                # face_results = {'face_1': {'score': 0.999509334564209, 'facial_area': [1176, 611, 1278, 747]}} # dict of face with bbox
