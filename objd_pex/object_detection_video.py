    ...
    try: 
        ...
        try: 
            ...
            try:
                ...
                if isinstance(img_source, str):     # For Video
...
def videoToFTP(img_array,size):
    ...
    # #AVI
    # out1 = cv2.VideoWriter('Object_Detection_Output_Video.avi',cv2.VideoWriter_fourcc(*'XVID'), video_fps, size)
...
def get_entities(video_url):
    ...
    try:
        ...
        for image_url in frame_urls:
            ...
            try:    
                ...
                try:
                    ...
                    bounded_figure = plot_Image_Boundings(objd_data, img, frame_size)
                    array_img = imageToNumpy(bounded_figure)
        ...
        ftp_url = videoToFTP(bounded_images, frame_size)
