...
#spark-submit --packages org.apache.spark:spark-streaming-kafka-0-8_2.11:2.4.7,org.apache.spark:spark-sql-kafka-0-10_2.11:2.4.0 --conf spark.sql.caseSensitive=True --py-files /home/hammad/VScodeProjects/Kafka_Screaming/OwlsenseStream.py /home/hammad/VScodeProjects/Kafka_Screaming/object_detection_stream.py

# For heap memory out
#spark-submit --packages org.apache.spark:spark-streaming-kafka-0-8_2.11:2.4.7,org.apache.spark:spark-sql-kafka-0-10_2.11:2.4.0 --conf spark.sql.caseSensitive=True --py-files /home/hammad/VScodeProjects/Kafka_Screaming/OwlsenseStream.py --driverMemory=8g /home/hammad/VScodeProjects/Kafka_Screaming/object_detection_stream.py