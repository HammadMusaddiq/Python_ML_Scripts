...
df = spark.read.json("/home/hammad/Downloads/objd_flask/st_rd_8383.json")
            ...
            if image_url != [] and image_url != None and image_url != 'default':
                ...
                try:    
                    ...
                    try:
                        ...
                        new_class_lst = []
                        for _score,_class in zip(objd_data['probability_score'],objd_data['object_classified']):
                            if float(_score) < 0.9:
                                new_class_lst.append('Unknown')
                            else:
                                new_class_lst.append(_class)
                        
                        results["predictions"].append(new_class_lst)
